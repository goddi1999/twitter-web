...
All audit work must follow the **audit-data** skill (`SKILL.md` + `reference.md`) as a binding contract, not guidance.
...
- Any migration that adds/changes audit triggers, audit RPCs, or audit payload fields must be reviewed against the **audit-data** allowlist/forbidden lists before merge.
